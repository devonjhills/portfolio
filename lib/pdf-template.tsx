...
const MarkdownElementComponent: React.FC<{ element: MarkdownElement }> = ({
  element,
}) => {
  switch (element.type) {
    case "heading":
      ...
      ...content.sections.map((section, sectionIndex) =>
        React.createElement(
          ...
          ...section.content.map((element, elementIndex) =>
            React.createElement(MarkdownElementComponent, {
              key: `element-${sectionIndex}-${elementIndex}`,
              element,
            }),
          ),
        ),
