        ...
        >
          ...
          <div
            style={{
              ...
              right: 0,
              bottom: 0,
              background: 'radial-gradient(circle at 20% 50%, rgba(120, 119, 198, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(120, 119, 198, 0.1) 0%, transparent 50%)',
            }}
          />
          ...
          >
            ...
            >
              {['React', 'Next.js', 'TypeScript', 'Python', 'AI/ML'].map((tech) => (
                <div
                  key={tech}
                  style={{
                    padding: '8px 16px',
