...
const experiences = [
  {
    ...
    duration: "3+ years",
    description: "Built and maintained React/TypeScript applications for HealthCare.gov health plan enrollment workflows, serving millions of users during high-traffic enrollment periods.",
    achievements: [
    ...
    technologies: ["React", "TypeScript", "Redux", "Ruby on Rails", "PostgreSQL", "AWS", "Jenkins", "Playwright"],
    current: true
  },
  {
    id: 2,
    ...
    duration: "3+ years",
    description: "Architected and maintained mission-critical software components using C++, conducting systematic debugging and root cause analysis for complex technical issues.",
    achievements: [
    ...
    technologies: ["C++", "Agile/SCRUM", "Technical Documentation", "Debugging", "Root Cause Analysis"],
    current: false
  },
  {
    id: 3,
    ...
    duration: "4 years",
    description: "Bachelor of Science in Computer Science with focus on software engineering principles and computer systems.",
    achievements: [
