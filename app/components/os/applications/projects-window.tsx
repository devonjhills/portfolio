        ...
        repos.map((repo) =>
          React.createElement(
            "a",
            {
              ...
              className:
                "group p-4 bg-gray-800 border border-gray-700 rounded-lg hover:border-primary/50 transition-all flex flex-col justify-between",
            },
            React.createElement(
              "div",
              {},
                  ...
                  repo.topics.slice(0, 3).map((topic) =>
                    React.createElement(
                      "span",
                      {
                        key: topic,
                        className:
                          "px-2 py-0.5 bg-gray-700 text-primary text-xs rounded-md",
                      },
                      topic,
                    ),
                  ),
            ...
            React.createElement(
              ...
              {
                className:
                  "flex items-center justify-between text-xs text-gray-400 pt-3 border-t border-gray-700",
              },
              React.createElement(
                "div",
