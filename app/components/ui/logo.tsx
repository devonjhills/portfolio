...
export function Logo({
    ...
    switch (variant) {
      case "primary":
        return {
          ...
          foreground: "fill-primary-foreground",
        };
      case "accent":
        return {
          background: "fill-accent",
          foreground: "fill-accent-foreground",
        };
      case "foreground":
        return {
          background: "fill-foreground",
          foreground: "fill-background",
        };
      default:
        return {
          background: "fill-primary",
  ...
  return (
    <svg
      ...
      height={size}
      className={className}
      aria-label="Devon Hills Logo"
    >
      <title>DH Monogram Logo</title>
      <defs>
        <clipPath id={`circleClip-${variant}-${size}`}>
